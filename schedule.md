...
- [Collective Operations](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/usage/collectives.html) (NCCL Documentation)
...
- [PyTorch Distributed](https://arxiv.org/abs/2006.15704) (Li et al., 2020)
...
- [Large Batch Training of Convolutional Networks](https://arxiv.org/abs/1708.03888) (You et al., 2017) — LARS
...
- [Check-N-Run](https://www.usenix.org/conference/nsdi24/presentation/wang-zhuang) (Wang et al., 2024)
- Key concepts: Asynchronous checkpointing, recovery strategies

**Thursday** — Cluster Scheduling and Resource Management
- [Pollux](https://www.usenix.org/conference/osdi21/presentation/qiao) (Qiao et al., 2021)
...
- [On the Variance of the Adaptive Learning Rate and Beyond](https://arxiv.org/abs/1908.03265) (Liu et al., 2019) — RAdam
...
- [The Pile](https://arxiv.org/abs/2101.00027) (Gao et al., 2020)
- [Dolma](https://arxiv.org/abs/2402.00159) (Soldaini et al., 2024)
...
- [FLAN: Finetuned Language Models Are Zero-Shot Learners](https://arxiv.org/abs/2109.01652) (Wei et al., 2021)
...
- [vLLM: Efficient Memory Management for LLM Serving](https://arxiv.org/abs/2309.06180) (Kwon et al., 2023)
